...
in
{
  options.home.firefox = {
    ...
    on-nixos = mkEnableOption "Whether the configuration is hosted on nixos (for plugin support)";
    # extsystem = mkOption {
  ...
  config = mkIf (homecfg.enable && cfg.enable) (mkMerge [
    {
      ...
      programs.firefox = {
        ...
        profiles.default = {
          extensions.packages = if cfgext then with osConfig; firefox-addons else with config; firefox-addons;
          ...
          search.engines = {
            ...
            "CustomDuckDuckGo".urls = [
              {
                template = "https://duckduckgo.com/?ks=s&k7=24273a&kae=d&kj=24273a&k9=8bd5ca&kaa=f5a97f&k21=363a4f&k1=-1&kak=-1&kax=-1&kaq=-1&kap=-1&kao=-1&kau=-1&q={searchTerms}";
              }
            ];
          ...
          settings = {
            ...
            "browser.fullscreen.autohide" = false; # do not hide tabs when fullscreen
            ...
            "privacy.clearOnShutdown_v2.cookiesAndStorage" = false; # this one clears cookies
