  ...
  programs.offlineimap = {
    ...
    pythonFile = ''
          ...
          def mailpasswd(account):
              ...
              args = ["gpg2", "-q", "--for-your-eyes-only", "--batch", "--passphrase-file", "${config.home.homeDirectory}/.nix.d/home/mail/.m9.txt","--no-tty", "-d", "${config.home.homeDirectory}/.nix.d/home/mail/.m9.gpg"]
              try:
